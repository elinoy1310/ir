...
**מגישות:** אלינוי דמרי 325984318, ריקי רובין 326380359 <br> 
**מספר קבוצת תרגיל:** 157125.21.5786.41 <br><br> 
...
- [שלב 2 – ניקוי קבצי הXML](#שלב-2--ניקוי-קבצי-הxml)
  ...
  - [שלב 2.2 – הפרדת סימני פיסוק](#שלב-22--הפרדת-סימני-פיסוק)
...
הערה: המטריצות נשמרו במבנה דליל (sparse) כדי לחסוך מקום בזיכרון, כי רוב הערכים הם אפסים. 
